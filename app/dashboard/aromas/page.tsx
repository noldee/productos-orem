...
import { Pencil, Trash2, Plus, Check, X, Loader2, Wind } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-stone-400 mt-0.5">
              {aromas.length}{" "}
              {aromas.length === 1 ? "aroma registrado" : "aromas registrados"}
            </p>
          </div>
        </div>
        <Button
